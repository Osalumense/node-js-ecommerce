  ...
  return (
    <Fragment>
      ...
      >
        ...
        <hr className="border-b border-gray-200" />
        <div
          onClick={(e) => history.push("/admin/dashboard/sale-requests")}
          className={`${
            location.pathname === "/admin/dashboard/sale-requests"
              ? "border-r-4 border-gray-800 bg-gray-100"
              : ""
          } hover:bg-gray-200 cursor-pointer flex flex-col items-center justify-center py-6`}
        >
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-gray-600 hover:text-gray-800"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24">
              <path
          ...
          <span className="hover:text-gray-800">Sale requests</span>
        </div>
        <hr className="border-b border-gray-200" />
      </div>
    </Fragment>
