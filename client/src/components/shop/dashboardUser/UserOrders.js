  ...
  return (
    <Fragment>
      <tr className="border-b">
        ...
        <td className="hover:bg-gray-200 p-2 text-center">{order.Order.phone}</td>
        <td className="hover:bg-gray-200 p-2 text-center">{order.Order.address}</td>
        <td className="hover:bg-gray-200 p-2 text-center">
        ...
        <td className="hover:bg-gray-200 p-2 text-center">
          {moment(order.Order.updatedAt).format("lll")}
        </td>
      </tr>
    </Fragment>
  );
