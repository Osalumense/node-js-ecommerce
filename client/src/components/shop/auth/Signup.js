      ...
      <form className="space-y-4">
        ...
        <div className="flex flex-col">
          <label htmlFor="firstName">
            firstName<span className="text-sm text-gray-600 ml-1">*</span>
          </label>
          <input
            onChange={(e) =>
              setData({
            ...
            id="firstName"
            className={`${
              data.error.firstName ? "border-red-500" : ""
            } px-4 py-2 focus:outline-none border`}
          />
          {!data.error ? "" : alert(data.error.firstName, "red")}
        </div>
        <div className="flex flex-col">
          <label htmlFor="lastName">
            lastName<span className="text-sm text-gray-600 ml-1">*</span>
          </label>
          <input
            onChange={(e) =>
              setData({
            ...
            id="lastName"
            className={`${
              data.error.lastName ? "border-red-500" : ""
            } px-4 py-2 focus:outline-none border`}
          />
          {!data.error ? "" : alert(data.error.lastName, "red")}
        </div>
        <div className="flex flex-col">
          <label htmlFor="email">
