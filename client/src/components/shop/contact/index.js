    ...
    <Fragment>
        <section className="text-gray-600 body-font relative mt-20 bg-gray-100 border-2">
            ...
            <div className="container px-5 py-24 mx-auto flex">
                <div className="lg:w-2/5 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
                <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Contact Us</h2>
                <p className="leading-relaxed mb-5 text-gray-600">Office address</p>
                ...
                <button className="text-white bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-900 rounded text-lg">Send Message</button>
